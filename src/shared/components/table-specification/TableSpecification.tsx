  ...
  return (
    <div className="flex flex-col">
      <div className="border-b border-white px-[4rem] hidden lg:grid grid-cols-3 min-h-[11rem]">
        ...
        <div className="text-[2.8rem] font-bold lg:flex items-center">Performance</div>
        
        <div className="text-[2.8rem] font-bold lg:flex items-center">Testing Methods</div>
      </div>
      ...
      {data.map((item, index) => (
        <div 
          ...
          key={index}
        >
          <div className="h-[6rem] lg:h-auto text-[2.4rem] lg:pr-[4rem] font-bold flex items-center">{item.title}</div>

          <div className="text-[2rem] lg:text-[2.4rem] hidden lg:flex items-center">{item.performance}</div>
          
          <div className="text-[2rem] lg:text-[2.4rem] hidden lg:flex items-center">{item.testingMethods}</div>
